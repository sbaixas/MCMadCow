...
public class EntityTrackerEntry {
   ...
   private Packet func_73124_b() {
      ...
      if(this.field_73132_a instanceof EntityItem) {
         EntityItem var11 = (EntityItem)this.field_73132_a;
         Packet21PickupSpawn var8 = new Packet21PickupSpawn(var11);
         var11.field_70165_t = (double)var8.field_73483_b / 32.0D;
         var11.field_70163_u = (double)var8.field_73484_c / 32.0D;
         var11.field_70161_v = (double)var8.field_73481_d / 32.0D;
         return var8;
         ...
         if(this.field_73132_a instanceof EntityMinecart) {
            var1 = (EntityMinecart)this.field_73132_a;
         ...
         if(this.field_73132_a instanceof EntityBoat) {
            ...
            if(this.field_73132_a instanceof EntityFishHook) {
               EntityPlayer var10 = ((EntityFishHook)this.field_73132_a).field_70204_b;
               return new Packet23VehicleSpawn(this.field_73132_a, 90, var10 != null?var10.field_70157_k:this.field_73132_a.field_70157_k);
            } else if(this.field_73132_a instanceof EntityArrow) {
               Entity var9 = ((EntityArrow)this.field_73132_a).field_70250_c;
               return new Packet23VehicleSpawn(this.field_73132_a, 60, var9 != null?var9.field_70157_k:this.field_73132_a.field_70157_k);
               ...
               if(this.field_73132_a instanceof EntitySmallFireball) {
                  EntitySmallFireball var7 = (EntitySmallFireball)this.field_73132_a;
                  var1 = null;
                  if(var7.field_70235_a != null) {
                     var4 = new Packet23VehicleSpawn(this.field_73132_a, 64, var7.field_70235_a.field_70157_k);
                  } else {
                     var4 = new Packet23VehicleSpawn(this.field_73132_a, 64, 0);
                  }

                  var4.field_73523_e = (int)(var7.field_70232_b * 8000.0D);
                  var4.field_73520_f = (int)(var7.field_70233_c * 8000.0D);
                  var4.field_73521_g = (int)(var7.field_70230_d * 8000.0D);
                  return var4;
                  ...
                  if(var6.field_70235_a != null) {
                     var4 = new Packet23VehicleSpawn(this.field_73132_a, 63, ((EntityFireball)this.field_73132_a).field_70235_a.field_70157_k);
                  } else {
                     var4 = new Packet23VehicleSpawn(this.field_73132_a, 63, 0);
                  }

                  var4.field_73523_e = (int)(var6.field_70232_b * 8000.0D);
                  var4.field_73520_f = (int)(var6.field_70233_c * 8000.0D);
                  var4.field_73521_g = (int)(var6.field_70230_d * 8000.0D);
                  return var4;
