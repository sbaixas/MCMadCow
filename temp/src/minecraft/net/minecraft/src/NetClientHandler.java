...
public class NetClientHandler extends NetHandler {
   ...
   public void func_72511_a(Packet23VehicleSpawn p_72511_1_) {
      ...
      if(var8 != null) {
         ...
         Entity[] var16 = ((Entity)var8).func_70021_al();
         if(var16 != null) {
            int var18 = p_72511_1_.field_73526_a - ((Entity)var8).field_70157_k;
            Entity[] var11 = var16;
            int var12 = var16.length;

            for(int var13 = 0; var13 < var12; ++var13) {
               Entity var14 = var11[var13];
               var14.field_70157_k += var18;
            }
         }
         ...
         if(p_72511_1_.field_73528_i > 0) {
            if(p_72511_1_.field_73527_h == 60) {
               Entity var19 = this.func_72545_a(p_72511_1_.field_73528_i);
               if(var19 instanceof EntityLiving) {
                  EntityArrow var17 = (EntityArrow)var8;
                  var17.field_70250_c = var19;
               }
            }
